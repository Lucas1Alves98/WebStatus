...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="index.php">Início</a></li>
			<li class="active">Área do Adm</li>
		</ol>

		<div class="row">
			
			<!-- Inicio do Login Admin -->
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title"><b>Administrador</b></h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Entre como administrador</h3>
